...
@section('breadcrumb')
    ...
    <div class="kt-subheader__breadcrumbs">
        ...
        <a href="{{route('exam.edit', $exam['id'])}}" class="kt-subheader__breadcrumbs-link">
            Edit Exam
        </a>
    </div>
@endsection
...
@section('content')
        ...
        <div class="col">
            <div class="alert alert-light alert-elevate fade show" role="alert">
                ...
                <div class="alert-text">
                    Pada page ini anda dapat mengupdate Exam dan Base Questions
                </div>
            </div>
        </div>
    </div>
    ...
    <form action="{{route('exam.update', $exam['id'])}}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                            ...
                            <div class="col-8">
                                <div id="bloodhound">
                                    <div class="input-group">
                                        <input name="exam_subjects" class="typeahead" id="tag1" type="text" class="form-control" autocomplete="off">
                                        <div class="input-group-append">
                                            <a type="button" class="btn btn-warning white-text" id="btn-reset"><i class="la la-refresh white-text"></i> Reset to initial value</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                              <input type="text" class="form-control" placeholder="Exam Title" name="exam_title" value="{{old('exam_title') ?? $exam['exam_title'] }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-4 col-form-label">
                            ...
                            <div class="col-8">
                                <input type="number" min="0" class="form-control" placeholder="Max Score" name="max_score" value="{{old('max_score') ?? $exam['max_score'] }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-4 col-form-label">
                            ...
                            <div class="col-8">
                                <div class="input-grup row" style="margin-left: 1px">
                                    ...
                                    <input type="number" min="0" class="form-control col-md-3" name="default_correct_point" value="{{old('default_correct_point') ?? $exam['default_correct_point']}}" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <div class="oecps-explanation-box">
                                    <div class="oecps-explanation-header">
                                        <div class="oecps-enable-button">
                                            <div class="input-group">
                                                <input type="checkbox" @if($exam['oecp_1']) checked @endif data-toggle="toggle" name="oecp_1" style="width: 50px" data-on="Enable" data-off="Disable">
                                            </div>
                                        </div>
                                ...
                                <div class="oecps-explanation-box">
                                    <div class="oecps-explanation-header">
                                        <div class="oecps-enable-button">
                                            <div class="input-group">
                                                <input type="checkbox" @if($exam['oecp_2']) checked @endif data-toggle="toggle" name="oecp_2" style="width: 50px" data-on="Enable" data-off="Disable">
                                            </div>
                                        </div>
                                         <div class="oecps-title">
                                ...
                                <div class="oecps-explanation-box">
                                    <div class="oecps-explanation-header">
                                        <div class="oecps-enable-button">
                                            <div class="input-group">
                                                <input type="checkbox" @if($exam['oecp_3']) checked @endif data-toggle="toggle" name="oecp_3" style="width: 50px" data-on="Enable" data-off="Disable">
                                            </div>
                                        </div>
                                         <div class="oecps-title">
                                ...
                                <div class="oecps-explanation-box">
                                    <div class="oecps-explanation-header">
                                        <div class="oecps-enable-button">
                                            <div class="input-group">
                                                <input type="checkbox" @if($exam['oecp_4']) checked @endif data-toggle="toggle" name="oecp_4" style="width: 50px" data-on="Enable" data-off="Disable">
                                            </div>
                                        </div>
                                         <div class="oecps-title">
                                ...
                                <div class="oecps-explanation-box">
                                    <div class="oecps-explanation-header">
                                        <div class="oecps-enable-button">
                                            <div class="input-group">
                                                <input type="checkbox" @if($exam['oecp_5']) checked @endif data-toggle="toggle" name="oecp_5" style="width: 50px" data-on="Enable" data-off="Disable">
                                            </div>
                                        </div>
                                         <div class="oecps-title">
                                ...
                                <div class="oecps-explanation-box">
                                    <div class="oecps-explanation-header">
                                        <div class="oecps-enable-button">
                                            <div class="input-group">
                                                <input type="checkbox" @if($exam['oecp_6']) checked @endif data-toggle="toggle" name="oecp_6" style="width: 50px" data-on="Enable" data-off="Disable">
                                            </div>
                                        </div>
                                         <div class="oecps-title">
                                ...
                                <div class="oecps-explanation-box">
                                    <div class="oecps-explanation-header">
                                        <div class="oecps-enable-button">
                                            <div class="input-group">
                                                <input type="checkbox" @if($exam['oecp_8']) checked @endif data-toggle="toggle" name="oecp_8" style="width: 50px" data-on="Enable" data-off="Disable">
                                            </div>
                                        </div>
                                         <div class="oecps-title">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="checkbox" checked data-toggle="toggle" data-size="sm" name="exam_status" style="width: 50px" data-on="Activate" data-off="Deactivate" @if($exam['exam_status'] == 'Active') checked @endif>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="kt-portlet" id="questions-form" @if(isset($exam_base_questions) && !empty($exam_base_questions)) @else style="display: none" @endif>
            <div class="row">
                <div class="col-md-12">
            ...
            <div id="kt_repeater_2">
                <div class="kt-portlet__body" data-repeater-list = "group-questions" style="padding-top:0 !important; padding-bottom:0 !important">
                    @include('layouts.notification')
                    @if(isset($exam_base_questions) && !empty($exam_base_questions))
                            ...
                            <div data-repeater-item="" class="row repeater-item" style="margin-top:5%; border-bottom:dashed 1px rgb(138, 132, 132)">
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select name="type" class="form-control question_type" onchange="setOptionGroup(this)" required>
                                                <option value="">Pilih Question Type</option>
                                                <option value="essay" @if($question['question']['type'] == 'essay') selected @endif>Essay</option>
                                                <option value="multiple_choice" @if($question['question']['type'] == 'multiple_choice') selected @endif>Multiple Choice</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                                        ...
                                                        @foreach ($question['question']['options'] as $key2 => $option)
                                                            <div data-repeater-item style="margin-bottom:1%" class="inner-repeater-item">
                                                                <div class="input-group row">
                                                                    ...
                                                                    <input type="text" name="option_label" class="form-control-sm col-md-2 option_label" value="{{$option['option_label']}}" style="border:solid 1px rgb(197, 194, 194); max-width:12% !important; text-align:center" readonly/>
                                                                    ...
                                                                    <input type="text" name="option_description" class="form-control-sm col-md-4 input-sm option_description" value="{{$option['option_description']}}" style="border:solid 1px rgb(197, 194, 194)" required/>
                                                                    <input type="checkbox" name="answer_status" class="form-control-sm col-md-1 answer_status" onclick="reinitAnswerStatus(this)" @if($option['answer_status'] == '1') checked @endif/>
                        ...
                        @endforeach
                    @else
                        @include('layouts.default_question_repeater')
                    @endif
...
@section('scripts')
    ...
    <script>
        ...
        function setSubjects(){
            ...
            $.each(data_subject_awal , function(i, item){
                elt.tagsinput("add", {
                    id:  item.id,
                    name: item.name
                });
