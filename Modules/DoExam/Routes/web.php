...
Route::group(['prefix' => 'doexam', 'middleware' => 'validate_session:entry'], function() {
    ...
    Route::post('submit', 'DoExamController@submitExam')->name('submit-exam')->middleware('restrict_exam_session');
    Route::post('submit/check', 'DoExamController@checkExamBeforeSubmit');
});
