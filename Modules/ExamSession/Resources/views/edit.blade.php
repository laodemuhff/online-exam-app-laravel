...
@section('breadcrumb')
    ...
    <div class="kt-subheader__breadcrumbs">
        ...
        <a href="{{route('exam-session.edit', $exam_session['id'])}}" class="kt-subheader__breadcrumbs-link">
            Edit Exam Session
        </a>
    </div>
@endsection
...
@section('content')
        ...
        <div class="col">
            <div class="alert alert-light alert-elevate fade show" role="alert">
                ...
                <div class="alert-text">
                    Pada page ini anda dapat mengedit Exam Session
                </div>
            </div>
        </div>
    </div>
    ...
    <form action="{{route('exam-session.update', $exam_session['id'])}}" method="POST">
        @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group row">
                            <label class="col-4 col-form-label">
                                <div class="pull-right">
                                    Session Code <i class="flaticon-info" data-toggle="kt-tooltip" data-placement="top" data-original-title="Exam Session Code"></i>
                                </div>
                            </label>
                            <div class="col-8">
                                <input type="text" class="form-control" name="exam_session_code" value="{{ $exam_session['exam_session_code'] }}" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-4 col-form-label">
                                <div class="pull-right">
                                    Exam <i class="flaticon-info" data-toggle="kt-tooltip" data-placement="top" data-original-title="Exam"></i>
                                </div>
                            </label>
                            <div class="col-8">
                                <select name="id_exam" id="id_exam" class="form-control" data-url="{{ url('exam/info') }}" disabled>
                                    <option value="">Pilih Exam</option>
                                    @foreach ($exams as $exam)
                                        <option value="{{$exam->id}}" @if($exam_session['id_exam'] == $exam->id) selected @endif>{{$exam->exam_title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row" id="exam_datetime_wrapper" @if(!isset($exam_session['exam_datetime'])) style="display: none" @endif>
                            <label class="col-4 col-form-label">
                                <div class="pull-right">
                            ...
                            <div class="col-8">
                                <input type="datetime-local" class="form-control" name="exam_datetime" value="{{ isset($exam_session['exam_datetime']) ? date('Y-m-d\TH:i', strtotime($exam_session['exam_datetime'])) : null }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="form-check">
                                    <input type="checkbox" name="start_anytime" class="form-check-input" @if(isset($exam_session['exam_datetime'])) checked @endif>
                                    <label class="form-check-label start-anytime-checkbox" for="exampleCheck1">Allow Automated Scheduling</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row" id="exam_duration_wrapper" @if(!isset($exam_session['exam_duration'])) style="display: none" @endif>
                            <label class="col-4 col-form-label">
                                <div class="pull-right">
                            ...
                            <div class="col-8">
                                <div class="suffix-number ms">
                                    <input type="number" class="form-control" id="exam_duration" name="exam_duration" min="15" max="180" value="{{ isset($exam_session['exam_duration']) ? $exam_session['exam_duration'] : '120' }}" required>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="form-check">
                                    <input type="checkbox" name="end_anytime" class="form-check-input" @if(isset($exam_session['exam_duration'])) checked @endif>
                                    <label class="form-check-label end-anytime-checkbox" for="exampleCheck1">Allow Automated Time Limiting</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row" id="register_duration_wrapper" @if(!isset($exam_session['register_duration'])) style="display: none" @endif>
                            <label class="col-4 col-form-label">
                                <div class="pull-right">
                            ...
                            <div class="col-8">
                                <div class="suffix-number ms">
                                    <input type="number" class="form-control" id="register_duration" name="register_duration" min="1" max="15" value="{{ isset($exam_session['register_duration']) ? $exam_session['register_duration'] : '15' }}" required>
                                </div>
                                {{-- <input type="text" class="form-control" style="width: 72%; display:inline-block" value="Scheduled At : -" readonly> --}}
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="form-check">
                                    <input type="checkbox" name="unbound_registration" class="form-check-input" @if(isset($exam_session['register_duration'])) checked @endif>
                            ...
                            <div class="col-8">
                                <div class="other-policies-form">
                                    <div class="form-check other-policies-checkbox">
                                        <input type="checkbox" name="allow_scrambled_questions" class="form-check-input" @if($exam_session['allow_scrambled_questions'] == '1') checked @endif>
                                        <label class="form-check-label unbound-registration-checkbox" for="exampleCheck1">Allow Scrambled Questions</label>
                                    </div>
                                    <div class="form-check other-policies-checkbox">
                                        <input type="checkbox" name="allow_scrambled_options" class="form-check-input" @if($exam_session['allow_scrambled_options'] == '1') checked @endif>
                                        <label class="form-check-label unbound-registration-checkbox" for="exampleCheck1">Allow Scrambled Options</label>
                                    </div>
                                    <div class="form-check other-policies-checkbox">
                                        <input type="checkbox" name="disallow_navigation" class="form-check-input" @if($exam_session['disallow_navigation'] == '1') checked @endif>
                                        <label class="form-check-label unbound-registration-checkbox" for="exampleCheck1">Disallow Navigation</label>
                                    </div>
                                    <div class="form-check other-policies-checkbox">
                                        <input type="checkbox" name="disallow_multiple_login" class="form-check-input" @if($exam_session['disallow_multiple_login'] == '1') checked @endif>
                                        <label class="form-check-label unbound-registration-checkbox" for="exampleCheck1">Disallow Multiple Login</label>
                                    </div>
                                     <div class="form-check other-policies-checkbox">
                                        <input type="checkbox" name="check_on_exam_similarity" class="form-check-input" @if($exam_session['check_on_exam_similarity'] == '1') checked @endif>
